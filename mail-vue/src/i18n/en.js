const en = {
    ...
    user: 'User',
    content: 'Body',
    searchByContent: 'Enter a keyword to search',
    ...
    aiAgentSave: 'Save',
    aiAgentProvider: 'Model Provider',
    aiAgentProviderWorkersAI: 'Cloudflare Workers AI (Built-in)',
    aiAgentProviderAIGateway: 'Cloudflare AI Gateway (Proxy)',
    aiAgentProviderCustom: 'Custom API (OpenAI Compatible)',
    aiAgentCfAccountId: 'Cloudflare Account ID',
    aiAgentCfAccountIdPlaceholder: 'e.g. 32-character hex ID',
    aiAgentAiGatewayId: 'AI Gateway ID',
    aiAgentAiGatewayIdPlaceholder: 'e.g. my-mail-gateway',
    aiAgentGatewayProvider: 'Gateway Downstream Provider',
    aiAgentGatewayProviderHelp: 'Downstream provider bound in Cloudflare AI Gateway, choose presets or Custom type',
    aiAgentGatewayCustomProvider: 'Custom Provider Name',
    aiAgentGatewayCustomProviderPlaceholder: 'e.g. custom-siliconflow (must start with custom-)',
    aiAgentGatewayCustomProviderHelp: 'Matches the custom provider endpoint in Cloudflare AI Gateway, must start with custom-',
    aiAgentBaseUrl: 'API Base URL',
    aiAgentBaseUrlPlaceholder: 'e.g. https://api.deepseek.com/v1',
    aiAgentApiKey: 'API Key',
    aiAgentApiKeyPlaceholder: 'Enter API Key',
    aiAgentModel: 'Model Name',
    aiAgentModelPlaceholder: 'Select or type a model name',
    aiAgentFetchModels: 'Fetch Models',
    aiAgentModelsFetched: 'Successfully fetched {count} models',
    aiAgentFetchModelsFailed: 'Failed to fetch models:',
    aiAgentTestConnection: 'Test Connection',
    aiAgentTesting: 'Testing...',
    aiAgentTestSuccess: 'Connection Successful',
    aiAgentTestSuccessMsg: 'Model connection healthy! Latency: {latency}ms',
    aiAgentTestFailed: 'Connection Test Failed',
    aiAgentWorkersAIHint: 'Uses Cloudflare native edge inference, zero-config out of the box.',
    aiAgentAIGatewayHint: 'Proxies via Cloudflare AI Gateway for edge caching, observability, rate limiting, and unified routing.',
    aiAgentCustomHint: 'Direct connection to OpenAI, DeepSeek, Qwen, OneAPI, or any OpenAI-compatible API.',
